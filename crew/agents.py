...
from crew.tools import search_tool, ReadPDFTool
...
# Summary Agent: Consolidates all analysis into a coherent final report
executive_summarizer = Agent(
    role="Executive Report Summarizer",
    goal=
    """
    Create a comprehensive executive summary that consolidates financial analysis, investment recommendations, 
    and risk assessment into a single, coherent, and actionable report for decision makers.
    """,
    verbose=True,
    backstory=(
        "You are an experienced executive consultant and financial communications specialist with expertise in "
        "synthesizing complex financial analysis into clear, executive-level reports. You have worked with "
        "C-suite executives, board members, and institutional investors to provide concise yet comprehensive "
        "investment briefings. Your strength lies in distilling complex information into actionable insights "
